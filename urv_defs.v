...
`define EXCEPT_IRQ_0 10
`define EXCEPT_IRQ_1 11
`define EXCEPT_IRQ_2 12
`define EXCEPT_IRQ_3 13
`define EXCEPT_IRQ_4 14
`define EXCEPT_IRQ_5 15
`define EXCEPT_IRQ_6 16
`define EXCEPT_IRQ_7 17
